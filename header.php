...
<?php 
	$phone_web = "+1-888-532-7409";
	$email_web = "help@flycheapreservation.com";
	$domainname_web_url_web ="flycheapreservation.com";
	$domainname_web = "Flycheap Reservation";
		...
		<nav class="navbar navbar-expand-lg navbar-light navleft_right-pading">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      ...
		      <ul class="navbar-nav mx-auto">
               ...
               <a href="tel:<?php echo $phone_web; ?>" class="header-btn2_web1">
              ...
              <div class="dropdown d-inline-block">
                  ...
                  <ul class="dropdown-menu my_account-dropdown">
                      ...
                      <li><a class="dropdown-item" href="<?= $baseURL ?>my-account/settings.php"><i class="fa-solid fa-gear"></i> Settings</a></li>
