...
function updateDisplay() {
    ...
    displayBox.textContent = `${counts.adult + counts.child + counts.infant} Passenger${(counts.adult + counts.child + counts.infant > 1 ? 's' : '')} - ${travelClass}`;
...
// Update cabin class when changed
document.getElementById('travelClass').addEventListener('change', updateDisplay);
