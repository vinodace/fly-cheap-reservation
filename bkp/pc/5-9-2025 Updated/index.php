                    ...
                    <div class="row">
                      <div class="col-sm-6 col-md-6 pe-md-0">
                        <div class="form-group" id="citySection">
                          ...
                          <input type="hidden" id="fromAirportCode" name="origin">    <!-- IATA Code -->
                      ...
                      <div class="col-sm-6 col-md-6 px-md-0">
                        <div class="form-group" id="citySection">
                          ...
                          <input type="hidden" id="toAirportCode" name="destination"> <!-- IATA Code -->
      ...
      <!-- <div class="col-md-4">
        <div class="disc_card">
          <div class="d-flex justify-content-between mb-2">
            <h2 class="wrap-subhding_web1 pt-0 text-primary">$243.98</h2>
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
              <img src="images/airplane.png" class="disc_route_img">
              <p class="disc_flight_num pt-1">13h35m</p>
            </div>  
            <div>
              <h4 class="disc_flight_route">LHR</h4>
              <p class="disc_flight_route_name">Dubai</p>
              <ul class="disc_flight_details">
                <li><i class="fa-solid fa-calendar-days"></i> 9/10/2025</li>
          ...
          <p class="disc_flight_num">ETIHAD AIRWAYS (EY215)</p>
        </div>
      </div> -->
    </div>
  </div>
...
fetch("get-flight-offers.php?origin=DEL&destination=LHR&date=2025-09-10&adults=1")
  .then(res => res.json())
  .then(data => {
    ...
    data.data.slice(0, cardLimit).forEach(flight => {
      ...
      // Airline name not available directly → fallback to carrier code
        ...
        <div class="col-md-4">
          <div class="disc_card">
            <div class="d-flex justify-content-between mb-2">
              ...
              <a href="booking.php?offerId=${flight.id}" class="disc_btn">Book Now</a>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div>
