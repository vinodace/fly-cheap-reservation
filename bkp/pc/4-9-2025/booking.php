      ...
      <div class="col-sm-12">
                      ...
                      for ($i = 1; $i <= $adults; $i++): ?>
                          <tr>
                              ...
                              <td>
                                  ...
                                  <input type="text" name="first-name[]" class="traveller-form-field" placeholder="eg.John" required>
                              </td>
                              <td>
                                  <label class="traveller-form-lbl">Last Name</label>
                                  <input type="text" name="last-name[]" class="traveller-form-field" placeholder="eg.Williams" required>
                              </td>
                              <td width="250">
              ...
              <div class="row">
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">Address 1</label><input type="text" name="address1" class="form-field" required>
                    </div>  
                  </div>
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                  ...
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">Country</label><input type="text" name="country" class="form-field" required>
                    </div>  
                  </div>
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">State</label><input type="text" name="state" class="form-field" required>
                    </div>  
                  </div>
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">City</label><input type="text" name="city" class="form-field" required>
                    </div>  
                  </div>
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">Zip Code</label><input type="text" name="zip" class="form-field" required>
                    </div>  
                  </div>
              </div>
          </div>
          ...
          <div class="flight-result-box">
              ...
              <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                        <label class="traveller-form-lbl">Phone</label><input type="text" name="phone" class="form-field" required>
                    </div>
                  </div>   
                  <div class="col-md-4">
                    <div class="form-group">
                        <label class="traveller-form-lbl">Email</label><input type="email" name="email" class="form-field" required>
                    </div>
                  </div>  
              </div>
          </div>
          ...
          <!-- Payment Info -->
          <div class="flight-result-box">
              <h1 class="wrap-subhding_web1 pb-4">Payment Information</h1>
              <div class="row">
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                        <label class="traveller-form-lbl">Payment Method<span class="red">*</span></label>
                        <select name="expiry_month" class="form-field">
                  ...
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                        <label class="traveller-form-lbl">Card Holder Name<span class="red">*</span></label>
                        <input type="text" name="card-holder-name" class="form-field" required>
                    </div>
                  </div>   
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                        <label class="traveller-form-lbl">Card Number<span class="red">*</span></label><input type="text" name="card-number" class="form-field" required>
                    </div>
                  </div>   
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">Expiry Date<span class="red">*</span></label>
                      <div class="row">
                        <div class="col-6">
                          <select name="expiry_month" class="form-field">
                        ...
                        <div class="col-6">
                          <select name="expiry_year" class="form-field">
                            <option value="0">Year</option>
                            <?php for ($i=2025; $i <=2045; $i++): ?>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <label class="traveller-form-lbl">CVV<span class="red">*</span></label><input type="text" name="cvv" class="form-field" required>
                    </div>
                  </div>   
              </div>
          </div>
          ...
          <div class="text-center mt-3">
              ...
              <button type="submit" class="submit-btn btn btn-success">Proceed to Confirm Booking</button>
          </div>
      </form>
      </div>
    </div>
